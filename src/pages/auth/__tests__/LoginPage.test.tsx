...
describe('LoginPage', () => {
  it('navigates to the dashboard once the auth service accepts the credentials', async () => {
  ...
  it('shows the auth service error and does not navigate for invalid credentials', async () => {
    const user = userEvent.setup();
    const { store } = renderLoginPage();
